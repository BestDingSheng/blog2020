...
!(function (e, t) {
  ...
  function Me(e, t, n) {
    'function' == typeof n
      ...
      : ((Do.get = n.get ? (!1 !== n.cache ? Pe(t) : n.get) : y),
    ...
    if (e) {
      for (
        var n = Array.isArray(e),
          ...
          i = n ? e : so ? Reflect.ownKeys(e) : Object.keys(e),
          o = 0;
        o < i.length;
        o++
      )
    ...
    return (
      gr(e, {
        ...
        start: function (e, a, u) {
          ...
          if ((s || (br(f), f.pre && (s = !0)), Os(f.tag) && (c = !0), s))
            $r(f);
          else {
            wr(f),
              kr(f),
        ...
        chars: function (e) {
          if (
            ...
            if (
              (e =
                c || e.trim() ? (Mr(i) ? e : tc(e)) : a && t.length ? ' ' : '')
            ) {
              var n;
              !s && ' ' !== e && (n = yr(e, xs))
  ...
  var za =
    ...
    Za = (function (r) {
      ...
      function m(e, n) {
        ...
        (A = e.data.hook),
          t(A) && (t(A.create) && A.create(ga, e), t(A.insert) && n.push(e));
      }
      function g(e) {
        for (var n, r = e; r; )
          t((n = r.context)) &&
